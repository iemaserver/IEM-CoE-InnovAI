...
function Events() {
  const openWorkshopLink = () => {
    window.open(
      "https://docs.google.com/document/d/1n0WJtpuE8wkoi2j0TZy5-0O-bRmDVO-I/edit?usp=sharing&ouid=105392973217178405576&rtpof=true&sd=true",
      "_blank"
    );
  };

  const handleCardClick = (event) => {
    if (event.target.innerText !== "Workshops") {
    ...
    <section className="events" id="events">
      <div className="container">
        ...
        <div className="events-cards">
          ...
          <div className="card" onClick={openWorkshopLink}>
